...
- [x] 1. Extend language detection in diffguard-domain
...
- [x] 2. Implement language-aware preprocessing
  - [x] 2.1 Add Language enum and syntax types to preprocessor
  ...
  - [x] 2.2 Extend Preprocessor to support language-specific syntax
  ...
  - [x] 2.3 Write property tests for language-aware preprocessing
    - **Property 3: Comment Masking by Language**
    - **Property 4: String Masking by Language**
    - **Validates: Requirements 2.1-2.8**

- [x] 3. Update evaluator to use language-aware preprocessing
  - [x] 3.1 Pass detected language to preprocessor in evaluate_lines
...
- [x] 5. Add built-in rules for multiple languages
  - [x] 5.1 Add Python built-in rules
  ...
  - [x] 5.2 Add JavaScript/TypeScript built-in rules
  ...
  - [x] 5.4 Write property test for built-in rules compilation
    - **Property 5: Built-in Rules Compile Successfully**
    - **Validates: Requirements 3.6**

- [x] 6. Enhance diff parser for special cases
  - [x] 6.1 Add detection functions for special diff content
  ...
  - [x] 6.2 Update parse_unified_diff to handle special cases
  ...
  - [x] 6.3 Write property tests for enhanced diff parsing
    - **Property 6: Diff Parser Skips Special Files**
    - **Property 7: Diff Parser Handles Renames**
    - **Property 8: Diff Parser Resilience**
    - **Validates: Requirements 4.1-4.6**

- [x] 7. Checkpoint - Ensure diff parser tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Generate and commit JSON schemas
  - [x] 8.1 Run xtask schema and commit results
  ...
  - [x] 8.2 Write property test for schema validation
...
- [x] 9. Add error message context tests
  - [x] 9.1 Write property test for error messages
...
- [x] 11. Create rule matcher fuzz target
  - [x] 11.1 Implement fuzz target for evaluate_lines
