...
use diffguard_types::{
    CHECK_SCHEMA_V1, CheckReceipt, ConfigFile, Defaults, DiffMeta, FailOn, Finding, MatchMode,
    RuleConfig, Scope, Severity, ToolMeta, Verdict, VerdictCounts, VerdictStatus,
};
